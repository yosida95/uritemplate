...
var (
	rangeVarchar = &unicode.RangeTable{
		R16: []unicode.Range16{
			unicode.Range16{Lo: 0x0030, Hi: 0x0039, Stride: 1}, // '0' - '9'
			unicode.Range16{Lo: 0x0041, Hi: 0x005A, Stride: 1}, // 'A' - 'Z'
			unicode.Range16{Lo: 0x005F, Hi: 0x005F, Stride: 1}, // '_'
			unicode.Range16{Lo: 0x0061, Hi: 0x007A, Stride: 1}, // 'a' - 'z'
		},
		LatinOffset: 4,
	}
	rangeLiterals = &unicode.RangeTable{
		R16: []unicode.Range16{
			unicode.Range16{Lo: 0x0021, Hi: 0x0021, Stride: 1}, // '!'
			unicode.Range16{Lo: 0x0023, Hi: 0x0024, Stride: 1}, // '#' - '$'
			unicode.Range16{Lo: 0x0026, Hi: 0x0026, Stride: 1}, // '&'
			unicode.Range16{Lo: 0x0028, Hi: 0x003B, Stride: 1}, // '(' - ';'
			unicode.Range16{Lo: 0x003D, Hi: 0x003D, Stride: 1}, // '='
			unicode.Range16{Lo: 0x003F, Hi: 0x005B, Stride: 1}, // '?' - '['
			unicode.Range16{Lo: 0x005D, Hi: 0x005D, Stride: 1}, // ']'
			unicode.Range16{Lo: 0x005F, Hi: 0x005F, Stride: 1}, // '_'
			unicode.Range16{Lo: 0x0061, Hi: 0x007A, Stride: 1}, // 'a' - 'z'
			unicode.Range16{Lo: 0x007E, Hi: 0x007E, Stride: 1}, // '~'
			unicode.Range16{Lo: 0x00A0, Hi: 0xD7FF, Stride: 1}, // ucschar
			unicode.Range16{Lo: 0xE000, Hi: 0xF8FF, Stride: 1}, // iprivate
			unicode.Range16{Lo: 0xF900, Hi: 0xFDCF, Stride: 1}, // ucschar
			unicode.Range16{Lo: 0xFDF0, Hi: 0xFFEF, Stride: 1}, // ucschar
		},
		R32: []unicode.Range32{
			unicode.Range32{Lo: 0x00010000, Hi: 0x0001FFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x00020000, Hi: 0x0002FFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x00030000, Hi: 0x0003FFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x00040000, Hi: 0x0004FFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x00050000, Hi: 0x0005FFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x00060000, Hi: 0x0006FFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x00070000, Hi: 0x0007FFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x00080000, Hi: 0x0008FFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x00090000, Hi: 0x0009FFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x000A0000, Hi: 0x000AFFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x000B0000, Hi: 0x000BFFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x000C0000, Hi: 0x000CFFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x000D0000, Hi: 0x000DFFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x000E1000, Hi: 0x000EFFFD, Stride: 1}, // ucschar
			unicode.Range32{Lo: 0x000F0000, Hi: 0x000FFFFD, Stride: 1}, // iprivate
			unicode.Range32{Lo: 0x00100000, Hi: 0x0010FFFD, Stride: 1}, // iprivate
		},
		LatinOffset: 10,
	}
)
