...
var (
	testTemplateCases = []struct {
		...
		{"{list*}", "red,green,blue", false},
		{"{keys}", "semi,%3B,dot,.,comma,%2C", false},
		...
		// § 3.2.5
		{"{.who}", ".fred", false},
		{"{.who,who}", ".fred.fred", false},
		{"{.half,who}", ".50%25.fred", false},
		{"www{.dom*}", "www.example.com", false},
		{"X{.var}", "X.value", false},
		{"X{.empty}", "X.", false},
		{"X{.undef}", "X", false},
		{"X{.var:3}", "X.val", false},
		...
		{"X{.list*}", "X.red.green.blue", false},
		{"X{.keys}", "X.semi,%3B,dot,.,comma,%2C", false},
		...
		{"{;keys}", ";keys=semi,%3B,dot,.,comma,%2C", false},
		{"{;keys*}", ";semi=%3B;dot=.;comma=%2C", true},
		// § 3.2.8
		{"{?who}", "?who=fred", false},
		{"{?half}", "?half=50%25", false},
